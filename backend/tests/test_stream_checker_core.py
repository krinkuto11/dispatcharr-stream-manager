...
class TestProgressTracking(unittest.TestCase):
    ...
    def test_total_streams_defined_before_use(self, mock_base_url, mock_fetch_data, mock_fetch_streams):
        ...
        service = StreamCheckerService(config_file)
        ...
        with patch('stream_checker_service.importlib.util.spec_from_file_location') as mock_spec:
            ...
            with patch('stream_checker_service.importlib.util.module_from_spec', return_value=mock_module):
